    ...
    def gen_update(self, data):
        ...
        while not update_finished:
            ...
            if self.last_step_count_G == self.opt_G._step_count:
                print("Generator overflowed! with step count [{}], total loss [{}]".format(self.opt_G._step_count, total_loss))
    ...
    def dis_update(self, data):
        ...
        while not update_finished:
            ...
            if self.last_step_count_D == self.opt_D._step_count:
                print("Discriminator overflowed! with step count [{}], total loss [{}]".format(self.opt_D._step_count, total_loss))
                if not torch.isfinite(total_loss):
